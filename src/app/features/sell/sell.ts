...
export class Sell {
  ...
  hero = {
    ...
    description: 'Reach thousands of genuine buyers across India. List your property with SkyDwell and get the best market value without any hassle.',
  ...
  whySell = {
    ...
    description: 'We help homeowners sell faster with verified buyers, professional marketing and transparent documentation. From listing to registration, we manage everything.'
  };
